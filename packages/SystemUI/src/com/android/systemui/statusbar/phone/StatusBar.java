...
public class StatusBar extends SystemUI implements
    ...
    public static FlashlightController mFlashlightController;
...
*/
    ...
    public NavigationBarController.SystemUiVisibility getNavigationBarSystemUiVisibility() {
        return mNavigationBarSystemUiVisibility;
    }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                mCommandQueueCallbacks.onCameraLaunchGestureDetected(StatusBarManager.CAMERA_LAUNCH_SOURCE_SCREEN_GESTURE);
            }
            Trace.endSection();
        }
    };
